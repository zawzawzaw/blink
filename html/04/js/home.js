$(function() {
	...
	function init () {
		...
		var headingTxtTween = TweenLite.from($headingDiv, 0.8, { scale: 0.2, opacity: 0, top: "300px", ease:Back.easeOut }); // bring in text;

		var scene = new ScrollScene({
			    triggerElement: $headingDiv,
			    triggerHook: 'onEnter',
			    duration: 0 /* How many pixels to scroll / animate */
		  	})
